...
class _Qwen35MoeNoSharedConfig(ModelQuantConfig):
...
Qwen35MoeNoSharedConfig = _Qwen35MoeNoSharedConfig(
    ...
    extra_quant_overrides={
        ...
        "*shared_expert.gate_proj*weight_quantizer": {"enable": False},
        "*shared_expert.gate_proj*input_quantizer": {"enable": False},
        "*shared_expert.up_proj*weight_quantizer": {"enable": False},
        "*shared_expert.up_proj*input_quantizer": {"enable": False},
        "*shared_expert.down_proj*weight_quantizer": {"enable": False},
        "*shared_expert.down_proj*input_quantizer": {"enable": False},
